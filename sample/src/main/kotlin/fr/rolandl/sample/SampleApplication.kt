...
import fr.rolandl.sample.app.SampleConnectivityListener
import fr.rolandl.sample.app.SampleInterceptor
  ...
  : RijselApplication<RijselApplication.ApplicationConstants>()
{
  ...
  override fun getI18N(): I18N =
      I18N(R.string.businessProblem, R.string.connectivityProblem, R.string.unavailableService)
  ...
  override fun getActivityRedirector(): RijselActivityController.Redirector
  {
    return RijselActivityController.Redirector { activity ->
      if (RijselSplashscreenActivity.isInitialized(SampleSplashscreenActivity::class) == null && activity is SampleSplashscreenActivity == false)
      {
