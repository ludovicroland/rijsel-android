 ...
 * @since 2018.11.07
 */
abstract class RijselSplashscreenActivity<AggregateClass : RijselActivityAggregate, ViewBindingClass : ViewBinding>
  : RijselAppCompatActivity<AggregateClass, ViewBindingClass>(),
    RijselSharedFlowListenerProvider
{
  ...
  {
    markAsInitialized(this@RijselSplashscreenActivity::class, true)
  }
